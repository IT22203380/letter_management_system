      ...
      <div className="space-y-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('common.additionalInformation')}</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex space-x-4">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-gray-700">{t('common.yes')}</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700">{t('common.no')}</span>
                  </label>
                </div>
              </div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <label className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700">{t('common.byHand')}</span>
                </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700">{t('common.postal')}</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            {formData.attachments && formData.attachments.length > 0 && (
              <div className="mt-4">
                <h4 className="text-sm font-medium text-gray-700 mb-2">{t('common.attachments')}</h4>
                    ...
                    <tr key={email.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {email.attachments?.length > 0 ? (
                          ...
                          <span className="text-xs text-gray-400">{t('noAttachments')}</span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeClass(email.status)}`}>
                          {email.status ? email.status.charAt(0).toUpperCase() + email.status.slice(1) : 'Pending'}
                        </span>
                      </td>
                    </tr>
                  ))}
